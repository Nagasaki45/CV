...
\begin{entrylist}
    ...
    \entry
    {2016}
    {\href{https://youtu.be/03c_yQZKopY}{Talk} {\normalfont on the \href{https://github.com/Nagasaki45/krihelinator/}{Krihelinator}}}
    {PyWebIL #55, Tel-Aviv}
    {Presenting the motivations for the project, the architecture, and reasons and advantages of choosing elixir.}
