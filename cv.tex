...
\textbf{web:} JavaScript, Vue.js, jQuery, D3, HTML, CSS, Bootstrap
...
\begin{entrylist}
    ...
    \entry
    {2016}
    {\href{https://youtu.be/03c_yQZKopY}{The Krihelinator}}
    {PyWebIL #55, Tel-Aviv}
    {Oral presentation the ``Krihelinator'' project.}
...
\begin{entrylist}
    ...
    \entry
    {2013}
    {\href{http://www.slideshare.net/Nagasaki45/audioonly-augmented-reality-system-for-social-interaction}{Audio-Only Augmented Reality System for Social Interaction}}
    {IEEE International Symposium on Technology and Society, Toronto}
    {Oral presentation of my masters thesis.}
...
\begin{entrylist}
    ...
    \entry
    {2013}
    {\href{http://www.tomgurion.me/pdfs/HCI2013 poster.pdf}{Audio-Only Augmented Reality System for Social Interaction}}
    {HCI International, Las Vegas}
    {Poster of my masters thesis.}
...
\begin{entrylist}
    ...
    \entry
    {2013}
    {\href{http://www.tomgurion.me/musigali.html}{MusiGali -- EEG controlled music project}}
